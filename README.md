...
7.open api.telegram.com/bot<scripttoken>/getUpdates 
10. Muncul id kamu setelah script chat
11. Salin ke script telah kamu dowonload ke dalam file .env
12. Sesuaikan ip server kamu pakai  di file .env
13. Nyalakan xampp apache dulu
14.Jalankan program dengan open file Aplikasi.bat 
15. Done
